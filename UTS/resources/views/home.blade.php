...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="container">
            ...
            <div class="col-lg-4 ">
                <div class="card mr-2 mb-2 ini-card" style="width: 18rem;">
                   <a href="{{route('detail',$hp->id)}}">
                    <img src={{$hp->thumbnail}} class="img-thumbnail" width="150px" max-height="425px" alt="...">
                   </a>
                    <div class="card-body">
        ...
        <div class="row">
            <h4 class="judul-laptops">Laptops</h4>
            @foreach ($laptops->products as $lt)
            <div class="col-lg-4 ">
                <div class="card mr-2 mb-2 ini-card" style="width: 18rem;">
                   <a href="{{route('detailLaptop',$lt->id)}}">
                    <img src={{$lt->thumbnail}} class="img-thumbnail" width="150px" max-height="425px" alt="...">
                   </a>
                    <div class="card-body">
                    <h5 class="card-title">{{$lt->title}}</h5>
                    <p class="card-text">{{$lt->description}}</p>
                    <a href="#" class="btn btn-primary add-cart">Add to Cart</a>
                    </div>
                </div>
            </div>
